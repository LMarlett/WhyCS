...
// to do send the results to back through axios
//
    ...
    return (
         <div>
          ...
          <Col sm="12" md={{ size: 10, offset: 1 }}>
           ...
           <Button className='quizbtnL' onClick={this.handleValidSubmit} outline color="secondary" id="D">Lorem ipsum dolor sit amet, consectetur 
             adipisicing elit, sed do eiusmod tempor incididunt ut labore (D)</Button>      
 
           <Button className='quizbtnR btn' onClick={this.handleValidSubmit} outline color="secondary"id="E">Lorem ipsum dolor sit amet, consectetur 
             adipisicing elit, sed do eiusmod tempor incididunt ut labore (E)</Button>      
