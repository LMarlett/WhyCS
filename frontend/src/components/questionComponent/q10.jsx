 ...
 class Q10 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[9][0][0].qText,
       qAcat: tuples[9][0][0].catID,
       qAid: tuples[9][0][0].qID,

       qB: tuples[9][1][0].qText,
       qBcat: tuples[9][1][0].catID,
       qBid: tuples[9][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">10 of 21</div>
            <Progress color="success" value={10} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q11'}/>
        )}
</div>
      );
  }
