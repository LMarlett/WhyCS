 ...
 class Q12 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[11][0][0].qText,
       qAcat: tuples[11][0][0].catID,
       qAid: tuples[11][0][0].qID,

       qB: tuples[11][1][0].qText,
       qBcat: tuples[11][1][0].catID,
       qBid: tuples[11][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">12 of 21</div>
            <Progress color="success" value={12} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q13'}/>
        )}
</div>
      );
  }
