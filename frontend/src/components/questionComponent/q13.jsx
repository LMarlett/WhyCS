 ...
 class Q13 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[12][0][0].qText,
       qAcat: tuples[12][0][0].catID,
       qAid: tuples[12][0][0].qID,

       qB: tuples[12][1][0].qText,
       qBcat: tuples[12][1][0].catID,
       qBid: tuples[12][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">13 of 21</div>
            <Progress color="success" value={13} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q14'}/>
        )}
</div>
      );
  }
