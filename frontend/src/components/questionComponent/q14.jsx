 ...
 class Q14 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[13][0][0].qText,
       qAcat: tuples[13][0][0].catID,
       qAid: tuples[13][0][0].qID,

       qB: tuples[13][1][0].qText,
       qBcat: tuples[13][1][0].catID,
       qBid: tuples[13][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">14 of 21</div>
            <Progress color="success" value={14} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q15'}/>
        )}
</div>
      );
  }
