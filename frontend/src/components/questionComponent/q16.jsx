 ...
 class Q16 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[15][0][0].qText,
       qAcat: tuples[15][0][0].catID,
       qAid: tuples[15][0][0].qID,

       qB: tuples[15][1][0].qText,
       qBcat: tuples[15][1][0].catID,
       qBid: tuples[15][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">16 of 21</div>
            <Progress color="success" value={16} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q17'}/>
        )}
</div>
      );
  }
