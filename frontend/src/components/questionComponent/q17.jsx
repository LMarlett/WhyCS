 ...
 class Q17 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[16][0][0].qText,
       qAcat: tuples[16][0][0].catID,
       qAid: tuples[16][0][0].qID,

       qB: tuples[16][1][0].qText,
       qBcat: tuples[16][1][0].catID,
       qBid: tuples[16][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">17 of 21</div>
            <Progress color="success" value={17} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q18'}/>
        )}
</div>
      );
  }
