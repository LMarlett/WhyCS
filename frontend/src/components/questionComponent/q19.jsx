 ...
 class Q19 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[18][0][0].qText,
       qAcat: tuples[18][0][0].catID,
       qAid: tuples[18][0][0].qID,

       qB: tuples[18][1][0].qText,
       qBcat: tuples[18][1][0].catID,
       qBid: tuples[18][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">19 of 21</div>
            <Progress color="success" value={19} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q20'}/>
        )}
</div>
      );
  }
