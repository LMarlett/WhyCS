 ...
 class Q21 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[20][0][0].qText,
       qAcat: tuples[20][0][0].catID,
       qAid: tuples[20][0][0].qID,

       qB: tuples[20][1][0].qText,
       qBcat: tuples[20][1][0].catID,
       qBid: tuples[20][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">21 of 21</div>
            <Progress color="success" value={21} max={21} />
            </div>
           </div>
          <br />
