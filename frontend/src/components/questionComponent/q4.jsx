 ...
 class Q4 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[3][0][0].qText,
       qAcat: tuples[3][0][0].catID,
       qAid: tuples[3][0][0].qID,

       qB: tuples[3][1][0].qText,
       qBcat: tuples[3][1][0].catID,
       qBid: tuples[3][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">4 of 21</div>
            <Progress color="success" value={4} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q5'}/>
        )}
</div>
      );
  }
