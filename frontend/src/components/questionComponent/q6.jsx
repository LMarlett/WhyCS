 ...
 class Q6 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[5][0][0].qText,
       qAcat: tuples[5][0][0].catID,
       qAid: tuples[5][0][0].qID,

       qB: tuples[5][1][0].qText,
       qBcat: tuples[5][1][0].catID,
       qBid: tuples[5][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">6 of 21</div>
            <Progress color="success" value={6} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q7'}/>
        )}
</div>
      );
  }
