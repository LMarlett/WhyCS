 ...
 class Q7 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[6][0][0].qText,
       qAcat: tuples[6][0][0].catID,
       qAid: tuples[6][0][0].qID,

       qB: tuples[6][1][0].qText,
       qBcat: tuples[6][1][0].catID,
       qBid: tuples[6][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">7 of 21</div>
            <Progress color="success" value={7} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q8'}/>
        )}
</div>
      );
  }
