 ...
 class Q8 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[7][0][0].qText,
       qAcat: tuples[7][0][0].catID,
       qAid: tuples[7][0][0].qID,

       qB: tuples[7][1][0].qText,
       qBcat: tuples[7][1][0].catID,
       qBid: tuples[7][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">8 of 21</div>
            <Progress color="success" value={8} max={21} />
            </div>
           </div>
          <br />
        ...
        {fireRedirect && (<Redirect to={from || '/quiz/q9'}/>
        )}
</div>
      );
  }
