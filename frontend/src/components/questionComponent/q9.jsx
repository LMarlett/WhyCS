 ...
 class Q9 extends Component {
  ...
  componentWillMount() {
   ...
   //alert(shuffledQ[0].qText);
    ...
    this.setState({
       qA: tuples[8][0][0].qText,
       qAcat: tuples[8][0][0].catID,
       qAid: tuples[8][0][0].qID,

       qB: tuples[8][1][0].qText,
       qBcat: tuples[8][1][0].catID,
       qBid: tuples[8][1][0].qID
  ...
  var rightSwitch = this.state.qBcat
    ...
    return (
     ...
     <div className="center">
            ...
            <div className="text-center">9 of 21</div>
            <Progress color="success" value={9} max={21} />
            </div>
           </div>
          <br />
